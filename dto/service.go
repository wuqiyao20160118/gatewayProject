...
type ServiceListInput struct {
	Info     string `json:"info" form:"info" comment:"keyword" example:"" validate:""`  // keyword
	PageNo   int    `json:"page_no" form:"page_no" comment:"Page Number" example:"1" validate:"required"`  // pageNo
	PageSize int    `json:"page_size" form:"page_size" comment:"Page Size" example:"20" validate:""`  // pageSize
}

type ServiceListOutput struct {
	Total int64                    `json:"total" form:"total" comment:"total number of result" example:"" validate:""`  // total
	List  []ServiceListItemOutput  `json:"list" form:"list" comment:"list" example:"" validate:""`   // list
}

type ServiceListItemOutput struct {
	ID          int64  `json:"id" form:"id"`                     // id
	ServiceName string `json:"service_name" form:"service_name"` // ServiceName
	ServiceDesc string `json:"service_desc" form:"service_desc"` // ServiceDesc
	LoadType    int    `json:"load_type" form:"load_type"`       // LoadType
	ServiceAddr string `json:"service_addr" form:"service_addr"` // ServiceAddr
	Qps         int64  `json:"qps" form:"qps"`                   // Qps
	Qpd         int64  `json:"qpd" form:"qpd"`                   // Qpd
	TotalNode   int    `json:"total_node" form:"total_node"`     // TotalNode
}

func (param *ServiceListInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}

type ServiceDeleteInput struct {
	ID int64 `json:"id" form:"id" comment:"service ID" example:"56" validate:"required"` //serviceID
}

func (param *ServiceDeleteInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
...
func (param *ServiceAddHTTPInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}
...
func (param *ServiceUpdateHTTPInput) BindingValidParams(c *gin.Context) error {
	return public.DefaultGetValidParams(c, param)
}

type ServiceStatOutput struct {
	Today     []int64 `json:"today" form:"today" comment:"今日流量" example:"" validate:""`         // list
	Yesterday []int64 `json:"yesterday" form:"yesterday" comment:"昨日流量" example:"" validate:""` // list
}
